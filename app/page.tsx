...
export default function Home() {
  ...
  return (
    <div>
      {isloading ? (
        <motion.div
          className="h-screen flex items-center justify-center bg-black select-none"
          animate={{
            opacity: [1, 1, 0],
            transition: {
              duration: 4,
        ...
        >
          <div className="flex flex-col items-end">
            <TextGenerateEffect
              words="C R E A T E"
              className="text-3xl lg:text-[10rem] font-extrabold text-white"
            />
            <TextGenerateEffect
              words="- with ADITYA JOHN."
              className="text-lg lg:text-2xl font-bold text-white relative lg:-top-2"
              duration={2}
              staggerdelay={0.8}
            />
          </div>
        ...
        <div className="h-screen w-full overflow-x-hidden overflow-y-auto snap-y snap-mandatory select-none background">
          ...
          >
            {activeSection === "projects" && (
              ...
              >
                <div className="text-white text-2xl h-full w-[50%] flex items-center justify-center">
                  {projects.map((item, i) => (
                    <div key={i}>
                      {i == itemData && (
                        <div className="flex flex-col gap-4 items-center justify-center">
                          ...
                          <div className="flex">
                            ...
                            <span className="bg-white/[0.4] p-2 rounded-2xl flex items-center justify-center gap-4">
                ...
                >
                  {projects.map((item, index) => (
                    <Card key={index}>
                      <span className="flex flex-col justify-between p-2 gap-2 h-full">
                        <span className="opacity-70 px-4 items-center justify-center flex">
                          <span className="font-bold lg:text-2xl md:text-lg noise bg-clip-text text-transparent text-base line-clamp-1 uppercase">
                            {item.title}
                          </span>
                        </span>
                        <Image
                          src={item.img}
                          alt={item.title}
                          className="z-10 object-cover h-[100%] w-[100vw] rounded-xl"
                          height={300}
                          width={500}
                        />
                      </span>
