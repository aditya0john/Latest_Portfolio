          ...
          >
            ...
            >
              {projects.map((item, index) => (
                <Card key={index}>
                  <span className="flex flex-col p-2 gap-2 h-full">
                    ...
                    <Image
                      src={item.img}
                      alt={item.title}
                      className="z-10 object-cover h-[300px] w-[100vw] lg:h-[300px] lg:w-[100vw] rounded-xl"
                      height={300}
                      width={500}
                    />
                    <div>
                      <div className="flex flex-col gap-4 items-center justify-center mr-20 ">
                        <span className="max-w-lg text-center text-xs lg:text-xl font-semibold italic text-white/80">
                          {item.des}
                        </span>
                        <div className="flex">
                          {item.iconLists.map((icons, i) => (
